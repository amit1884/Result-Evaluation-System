...
<input type ="text" name = "user-email" placeholder = "Email" class = "text-box">
<input type ="password" name = "pwd" placeholder = "Password" class = "text-box">
<center><button class = "btn btn-lg btn-success" name = "submit" type ="submit">Show Admit Card</button></center>
</form>
</div>
    </div>
</div>
